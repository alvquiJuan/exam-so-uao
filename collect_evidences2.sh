...
echo "Verificando punto 1" | lolcat
...
echo "Verificando punto 2" | lolcat
...
echo "Verificando punto 3" | lolcat
...
echo "Las validaciones se han completado y se han recopilado en el archivo 'evidencias.log'." | lolcat
